    ...
    >
      <v-card tile :project="currentProject">
        <v-card-title>
          ...
          <v-spacer></v-spacer>
          <span class="overline font-weight-light grey--text"
        ...
        <v-card-text class="pt-16 px-0 px-sm-4 px-md-16">
            ...
            <v-row>
              ...
              <v-col cols="12" md="3">
                ...
                <v-row class="ma-0 pb-8" v-if="currentProject.url">
                  <v-btn large light color="accent" :href="currentProject.url"
                    >View site</v-btn
                  >
                </v-row>
              </v-col>
          ...
          <v-list subheader class="my-16">
            <v-subheader class="overline font-weight-light grey--text"
                    ...
                    <template v-slot:default="{ hover }" color="primary">
                      ...
                      >
                        ...
                        >
                          ...
                          >
                          <v-card-title
                            class="card-text pt-0 hidden-md-and-up font-weight-bold"
